...
void NAOKinematics::forwardRightHand(kmatTable & EndTransf, double ShoulderPitch, double ShoulderRoll, double ElbowYaw, double ElbowRoll)
{
	KMatTransf::makeDHTransformation(T1, 0.0, -PI / 2, 0.0, ShoulderPitch);
...
NAOKinematics::FKvars NAOKinematics::calculateCenterOfMass(std::vector<double> allJoints)
{
	...
	KMath::KMat::GenMatrix<double, 3, 1> lh1, lh2, lh3, lh4, rh1, rh2, rh3, rh4, ll1, ll2, ll3, ll4, ll5, ll6, rl1, rl2, rl3, rl4, rl5, rl6, h1, h2, t;
